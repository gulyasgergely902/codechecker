...
class SourceCodeCommentTestCase(unittest.TestCase):
    ...
    def test_no_src_comment_comment(self):
        ...
        expected = SourceCodeComment(
            checkers={'all'},
            message='some comment',
            status='false_positive',
            line='// codechecker_suppress [all] some comment\n')
        self.assertEqual(expected, source_line_comments[0])
    ...
    def test_one_liner_some_checkers(self):
        ...
        expected = SourceCodeComment(
            ...
            status='false_positive',
            line='// codechecker_suppress [my.Checker_1, my.Checker_2] '
                 'some really\n // really\n'
                 ' // long comment\n')
        self.assertEqual(expected, source_line_comments[0])
    ...
    def test_false_positive_comment(self):
        ...
        expected = SourceCodeComment(
            ...
            message='some comment',
            status='false_positive',
            line='// codechecker_false_positive [ all ] some comment\n')
        self.assertEqual(expected, source_line_comments[0])
    ...
    def test_intentional_comment(self):
        ...
        expected = SourceCodeComment(
            ...
            message='some comment',
            status='intentional',
            line='// codechecker_intentional [ all ] some comment\n')
        self.assertEqual(expected, source_line_comments[0])
    ...
    def test_multiple_comments(self):
        ...
        self.assertEqual(expected[0], source_line_comments[0])
        self.assertEqual(expected[1], source_line_comments[1])

        current_line_comments = sc_handler.filter_source_line_comments(
            self.__tmp_srcfile_3, bug_line, 'my.checker_1')
        self.assertEqual(len(current_line_comments), 1)

        self.assertEqual(current_line_comments[0].message, expected[0].message)
        self.assertEqual(current_line_comments[0].status, expected[0].status)

        current_line_comments = sc_handler.filter_source_line_comments(
            self.__tmp_srcfile_3, bug_line, 'my.checker_2')
        self.assertEqual(len(current_line_comments), 1)

        self.assertEqual(current_line_comments[0].message, expected[1].message)
        self.assertEqual(current_line_comments[0].status, expected[1].status)

        current_line_comments = sc_handler.filter_source_line_comments(
            self.__tmp_srcfile_3, bug_line, 'my.dummy')
